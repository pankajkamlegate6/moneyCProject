...
public class CommoditiesWatchlistAdapter extends BaseAdapter {
	...
	public CommoditiesWatchlistAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		vHolder.crossImage.setTag(UrlUtils.deleteWatchListCommodity(mContext,
