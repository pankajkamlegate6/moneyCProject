...
public class MyPortfolioStocksAdapter extends BaseAdapter {

	private Context mContext;
	private LayoutInflater mInflator;
	private ArrayList<MyStocksPortfolioStocksItemData> list = null;

	public MyPortfolioStocksAdapter(Context context,
			ArrayList<MyStocksPortfolioStocksItemData> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tvInvestments.setText(list.get(position).getShortname());
		holder.tvInvestmentsValue.setText(list.get(position).getLastvalue());
