...
public class OHLCChartFragment extends BaseFragement implements
		OnChartGestureListener, OnChartValueSelectedListener {
	private OHLCStickChart mChart;
	private StickGraphBean graphData;
	private String url;
	private ArrayList<String> volumelist = new ArrayList<String>();
	private ArrayList<Values> datalist = new ArrayList<Values>();
	private RelativeLayout progressBarr;

	public OHLCStickChart getChart() {
		return mChart;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		mainView = inflater.inflate(R.layout.fragment_ohlc_chart, null);
		return mainView;
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		mChart = (OHLCStickChart) findViewById(R.id.candlechart);
	...
	void setdata() {
		if (graphData != null && graphData.getGraph() != null) {
			...
			for (int i = 0; i < datalist.size(); i++) {
				...
				volumelist.add("" + values.getVolume());
	...
	public void updateChart(String time_tag) {
		if (time_tag != null) {
			String url = time_tag + "&type=ohlc&flag=1&t_version="
