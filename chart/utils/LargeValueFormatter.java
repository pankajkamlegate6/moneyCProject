...
public class LargeValueFormatter implements ValueFormatter {
	...
	public String getFormattedValue(float value) {
		return makePrettyMoneyControl(value);
	}
	...
	private String makePrettyMoneyControl(double number) {
	...
	public static String makePrettyMoneyControlV2(double number) {
		double eff_rate = ((number / 1000));
		DecimalFormat formatter = new DecimalFormat("#.##");
		// formatter.setRoundingMode(RoundingMode.DOWN);

		return Double.valueOf(formatter.format(eff_rate)) + "k";
