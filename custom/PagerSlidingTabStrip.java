...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int scrollOffset = 6; // 52;
	private int indicatorHeight = 4; // 8;
	private int underlineHeight = 2;
	private int dividerPadding = 12;
	private int tabPadding = 9; // 24;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		indicatorHeight = (int) context.getResources().getDimension(
				R.dimen.pager_tab_indicator_thickness);
	...
	private void addTextTab(final int position, String title) {
		...
		SharedPreferences sp = mContext.getSharedPreferences(
				"language_selection", Context.MODE_PRIVATE);
		String language = sp.getString("language", "English");

		if (language != null) {
			if (language.equalsIgnoreCase("Gujrati")) {
				this.tabTypeface = Typeface.createFromAsset(
						mContext.getAssets(), "fonts/Lohit-Gujarati.ttf");
			} else {
				this.tabTypeface = Typeface.createFromAsset(
	...
	private void addTab(final int position, View tab) {
		...
		tab.setPadding(tabPadding, tabPadding, tabPadding, 0);
		tabsContainer
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				/*
				 * if (textAllCaps) { if (Build.VERSION.SDK_INT >=
				 * Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
				 * tab.setAllCaps(true); } else {
	...
	public void setIndicatorColor(int indicatorColor) {
		this.indicatorColor = getResources().getColor(
				R.color.orange_indice_overview);
	...
	/*
	 * public void setTabBackground(int resId) { this.tabBackgroundResId =
	 * resId; }
	 * 
	 * public int getTabBackground() { return tabBackgroundResId; }
	 */
